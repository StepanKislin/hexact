...
// Добавляем контейнер для диаграмм
    ...
    const shapes = detectAllShapes(gray);
// Фильтруем только шестигранники (гайки не бывают круглыми или Phillips)
